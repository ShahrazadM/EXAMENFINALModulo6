...
<title>PREVENSION 2.0 SOCIEDAD LIMITADA</title>
<!-- Hoja de estilo -->
        <link rel="stylesheet" href="<core:url value="/res/css/estilo.css" />">
</head>
<body>
    <h1>Comprometidos con la Seguridad</h1>
    <p>Somos una empresa dedicada a la prevención de riesgos, enfocada en garantizar la seguridad y protección de nuestros clientes.</p>
	...
	<p>Contamos con un personal altamente capacitado:Gabriel (Gerente en Finanzas corporativas); Frasiel (Ingeniera Informatica);Ruben(Manager Markething); Nayareth Sepulveda(Gerente Recursos Humanos)Y Scherezade Huancapaza ( Key Account Manager)</p>
